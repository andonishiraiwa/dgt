...
<div class="jumbotron">
	...
	<h2>Especifique los detalles de la multa para <span class="text-info">0000XYZ ${matricula}</span></h2> 
...
<br/>
	<form novalidate action="buscar" method="post" class="form-signin">
		...
		<label for="importe" class="h5">Importe</label><br/> <input type="text"
			name="importe" class="form-control" placeholder="cantidad en euros" required
			autofocus> <br />
			
			<label for="concepto" class="h5">Concepto</label> <br/><input type="text"
			name="concepto" class="form-control" placeholder="indique el asunto de la multa" required
			autofocus> <br />
